  ...
  return (
    <div style={{ marginTop: '6em', padding: '0em 1em', marginBottom: '13em' }}>
      ...
      {temRegistro ? (
        <div>
          {images.map((img) => (
            <div key={img.id} style={{backgroundColor: "var(--colorFundoAlter)"}}>
              <div style={{display: 'flex',justifyContent: 'center'}}>
                <img src={img.imageUrl} alt={img.imageDescription} style={{maxHeight: '14em'}}
                onError={(e) => { e.target.onerror = null; e.target.src = 'https://placehold.co/400x200/cccccc/ffffff?text=Imagem+N/A' }} />
              </div>
